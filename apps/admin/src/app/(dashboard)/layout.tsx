  ...
  return (
    <div className="min-h-screen bg-surface-secondary flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="bg-white/80 backdrop-blur-md border-b border-border-light h-14 flex items-center justify-between px-6 pl-16 md:pl-6 shrink-0 sticky top-0 z-30">
          <div />
